...
import { createResult, getQuestion, mapMergedQuestionAnswersToOriginal } from './helpers.js'
...
describe('Transform merged QuestionAnswers into original QuestionAnswers', () => {
  test('country matches country', () => {
    ...
    expect(mapMergedQuestionAnswersToOriginal(newQuestionAnswers)).toStrictEqual(oldQuestionAnswers)
  })
